		...
		<div class="col-md-12">
			<div class="soplanning-box">
					...
					<div class="btn-group" id="dropdownTaskLieuxFilter">
										...
										<button class="btn {if $filtreGroupeLieu|@count > 0}btn-danger{else}btn-default{/if} dropdown-toggle" data-toggle="dropdown"><i class="fa fa-map-marker fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-md-inline-block">&nbsp;{#taches_filtreLieux#}</span></button>
					...
					<div class="btn-group" id="dropdownTaskRessourceFilter">						
						<button class="btn {if $filtreGroupeRessource|@count > 0}btn-danger{else}btn-default{/if} dropdown-toggle" data-toggle="dropdown"><i class="fa fa-plug fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-md-inline-block">&nbsp;{#taches_filtreRessources#}</span></button>
										<ul class="dropdown-menu">
										<li>
										<table onClick="event.cancelBubble=true;" class="planning-filter"><tr>
											<td class="planningDropdownFilter">
		...
		<div class="col-md-12">
			<div class="soplanning-box">
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="checkbox" name="statut[]" id="{$statut.status_id}" value="{$statut.status_id}" onclick="javascript:$('#filtreprojet').submit();" {if in_array($statut.status_id, $listeStatuts)}checked="checked"{/if}>
