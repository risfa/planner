			...
			<div class="soplanning-box">
				<div class="btn-group">
					...
					<div class="btn-group" id="dropdownExport">
						<button class="btn dropdown-toggle btn-default" data-toggle="dropdown"><i class="fa fa-upload fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-md-inline-block">&nbsp;&nbsp;{#feries_import#}</span>&nbsp;<span class="caret"></span></button>
