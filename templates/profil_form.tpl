...
<form method="post" action="" target="_blank" name="formUser"  onSubmit="return false;">
	...
	<div class="form-group row">
		<div class="offset-md-4 col-md-6 form-check form-check-inline">
		<div class="form-check">
			<input class="form-check-input" type="radio" id="vueDefautMois" name="user_prefs_vuedefaut_largereduit" value="vueMois" {if $user_form.tabPreferences.vueJourMois eq "" or $user_form.tabPreferences.vueJourMois eq "vueMois"}checked="checked"{/if}>
			<label class="form-check-label" for="vueDefautMois">{#menuPlanningReduit#}</label>
		</div>
		<div class="form-check">
			<input class="form-check-input" type="radio" id="vueDefautJour" name="user_prefs_vuedefaut_largereduit" value="vueJour" {if $user_form.tabPreferences.vueLargeReduit eq "vueLarge"}checked="checked"{/if}>
			<label class="form-check-label" for="vueDefautJour">{#menuPlanningLarge#}</label>
		</div>
		</div>
	</div>	
