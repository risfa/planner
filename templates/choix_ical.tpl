...
<form class="form-horizontal" id="formIcal">
	<div class="form-group row">
		...
		<div class="col-md-8 radio-inline">
			<input type="radio" name="ical_users" id="ical_users_moi" value="ical_users_moi" checked="checked" onClick="xajax_icalGenererLien(getRadioValue('ical_users'), getRadioValue('ical_projets'), getSelectValue('icalProjetsChoix'));">
			<label for="ical_users_moi">{#icalExport_users_moi#}</label>
			<br />
			<input type="radio" name="ical_users" id="ical_users_tous" value="ical_users_tous" onClick="xajax_icalGenererLien(getRadioValue('ical_users'), getRadioValue('ical_projets'), getSelectValue('icalProjetsChoix'));">
	...
	<div class="form-group row">
		...
		<div class="col-md-8 radio-inline">
			<input type="radio" name="ical_projets" id="ical_projets_tous" value="ical_projets_tous" checked="checked" onClick="$('#divIcalProjets').addClass('hidden');" onClick="xajax_icalGenererLien(getRadioValue('ical_users'), getRadioValue('ical_projets'), getSelectValue('icalProjetsChoix'));">
			<label for="ical_projets_tous">{#icalExport_projets_tous#}</label>
			<br />
			<input type="radio" name="ical_projets" id="ical_projets_liste" value="ical_projets_liste" onClick="$('#divIcalProjets').removeClass('hidden');xajax_icalGenererLien(getRadioValue('ical_users'), getRadioValue('ical_projets'), getSelectValue('icalProjetsChoix'));">
