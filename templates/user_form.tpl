	...
	<div class="tab-content">	
		...
		<div class="tab-pane container fade" id="perso">
			...
			<label class="col-form-label col-md-3">{#user_login_actif#} :</label>
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="visible_planning" id="visible_planningNon" value="non" {if ($user_form.saved eq 0) || ($user_form.visible_planning eq "non")}checked="checked"{/if}>
