...
INSERT INTO `planning_config` VALUES('CURRENT_VERSION', '1.44', 'Internal key for auto upgrade control');
...
ALTER TABLE `planning_right_on_user`
  ...
  CREATE TABLE `planning_status` (
    ...
    `defaut` VARCHAR(2) NULL DEFAULT '0',
  ...
  INSERT INTO `planning_status` (`status_id`, `nom`, `commentaire`,`affichage`,`pourcentage`,`priorite`,`defaut`) VALUES ('a_faire', '#winPeriode_statut_a_faire#', '#winPeriode_statut_a_faire#','tp',0,1,'tp');
  ...
  INSERT INTO `planning_status` (`status_id`, `nom`, `commentaire`,`affichage`,`pourcentage`,`priorite`,`barre`) VALUES ('fait', '#winPeriode_statut_fait#', '#winPeriode_statut_fait#','tp',100,3,1);
  INSERT INTO `planning_status` (`status_id`, `nom`, `commentaire`,`affichage`,`pourcentage`,`priorite`,`barre`) VALUES ('abandon', '#winPeriode_statut_abandon#', '#winPeriode_statut_abandon#','tp',100,4,1);
  INSERT INTO `planning_status` (`status_id`, `nom`, `commentaire`,`affichage`,`pourcentage`,`priorite`,`barre`) VALUES ('archive', '#winPeriode_statut_archive#', '#winPeriode_statut_archive#','p',100,4,1);
